...
namespace Drupal\jp_product\Controller;

use Drupal\Core\Controller\ControllerBase;
use Drupal\jp_product\Response\QRImageResponse;
...
class QRImageGeneratorController extends ControllerBase {
  ...
  public function getLogoWidth() {
    return $this->config('jp_product.settings')->get('logo_width');
  }
  ...
  public function getLogoSize() {
    return $this->config('jp_product.settings')->get('set_size');
  }
  ...
  public function getLogoMargin() {
    return $this->config('jp_product.settings')->get('set_margin');
  }

  /**
   * Will return the response for external url.
   *
   * @return \Drupal\jp_product\Response\QRImageRespons
